...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, partial_size=0):
...
class PartialSequentialSampler(Sampler):
    ...
    def __init__(self, data_source, partial_size):
        self.data_source = data_source
        self.partial_size = partial_size

    def __iter__(self):
        return iter(range(self.partial_size))
