...
from layers import Conv2d, FrozenBatchNorm2d, DeformConv2d
from utils.registry import Registry
from config import Global_Group_Num
...
StageSpec = namedtuple(
    ...
    [
        ...
        "use_deform",  # adptation for Deformable Convolution, whether use deform conv in certain layer
...
ResNet50StagesTo5 = tuple(
    StageSpec(index=i, block_count=c, use_deform=d, return_features=r)
    for (i, c, d, r) in ((1, 3, False, False), (2, 4, False, False), (3, 6, False, False), (4, 3, False, True))
)
# ResNet-50 up to stage 4 (excludes stage 5)
ResNet50StagesTo4 = tuple(
    StageSpec(index=i, block_count=c, use_deform=d, return_features=r)
    for (i, c, d, r) in ((1, 3, False, False), (2, 4, False, False), (3, 6, False, True))
)
# ResNet-50-FPN (including all stages)
ResNet50FPNStagesTo5 = tuple(
    StageSpec(index=i, block_count=c, use_deform=d, return_features=r)
    for (i, c, d, r) in ((1, 3, False, True), (2, 4, False, True), (3, 6, False, True), (4, 3, False, True))
)
# ResNet-101-FPN (including all stages)
ResNet101FPNStagesTo5 = tuple(
    StageSpec(index=i, block_count=c, use_deform=d, return_features=r)
    for (i, c, d, r) in ((1, 3, False, True), (2, 4, False, True), (3, 23, False, True), (4, 3, False, True))
)
...
class ResNet(nn.Module):
    def __init__(self, cfg):
        ...
        default_transformation_module = _TRANSFORMATION_MODULES[cfg.MODEL.RESNETS.TRANS_FUNC]
        deform_transformation_module = _TRANSFORMATION_MODULES[cfg.MODEL.RESNETS.DEFORM_TRANS_FUNC]
        ...
        for stage_spec in stage_specs:
            ...
            if stage_spec.use_deform:
                transformation_module = deform_transformation_module
            else:
                transformation_module = default_transformation_module
...
class DeformConvBottleneckWithGroupNorm(nn.Module):
    def __init__(
        self,
        in_channels,
        bottleneck_channels,
...
_TRANSFORMATION_MODULES = Registry({
    ...
    "DeformConvBottleneckWithGroupNorm": DeformConvBottleneckWithGroupNorm
})
