...
class DeformMaskRCNNC5Predictor(nn.Module):
...
_ROI_MASK_PREDICTOR = {"MaskRCNNC4Predictor": MaskRCNNC4Predictor, "DeformMaskRCNNC5Predictor":DeformMaskRCNNC5Predictor}
